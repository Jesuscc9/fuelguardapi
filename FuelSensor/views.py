...
from .serializers import (
    TruckReadSerializer, TruckWriteSerializer,
    FuelSensorReadSerializer, FuelSensorWriteSerializer,
    FuelDataReadSerializer, FuelDataWriteSerializer,
    AlertReadSerializer, AlertWriteSerializer,
    GeofenceReadSerializer, GeofenceWriteSerializer,
    FuelHistoryReadSerializer, FuelHistoryWriteSerializer
)
